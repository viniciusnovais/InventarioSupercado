...
public abstract class PrincipalActivity extends AppCompatActivity {
    ...
    private void initViews(View view) {
        ...
        tvPerfil.setText(getString(R.string.perfil_dois_pontos).concat(" ").concat(preferences.getString(getString(R.string.preference_desc_perfil), "")));
        tvUsuario.setText(getString(R.string.usuario_dois_pontos).concat(" ").concat(preferences.getString(getString(R.string.preference_nome_usuario), "")));
