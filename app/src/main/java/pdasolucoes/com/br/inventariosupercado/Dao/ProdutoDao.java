...
public interface ProdutoDao {
    ...
    @Query("SELECT 1 FROM PDA_TB_PRODUTO WHERE codSku NOT IN(SELECT codSku FROM PDA_TB_COLETA_ITEM WHERE tipoAtividade ="+Constante.ATIVIDADE_CONTAGEM+")")
    int existePendencias();
